      ...
      <Container>
        <div className=" gap-16 flex flex-row items-end">
          ...
          <div className=" w-7/12 gap-8 grid grid-cols-5 ">
            <Image className="col-span-3  w-full" src={aboutImage1} />
            <Image className="col-span-2  w-full" src={aboutImage2} />
            <Image className="col-span-5  w-full" src={aboutImage3} />
          </div>
          {/* Right */}
